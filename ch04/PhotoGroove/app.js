...
var $author$project$PhotoGroove$initialModel = {choosenSize: $author$project$PhotoGroove$Medium, status: $author$project$PhotoGroove$Loading};
		...
		function () {
			...
			switch (_v0.$) {
				case 'Loaded':
					...
					return A3($author$project$PhotoGroove$viewLoaded, photos, selectedUrl, model.choosenSize);
				case 'Loading':
					return _List_Nil;
				default:
