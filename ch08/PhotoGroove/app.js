...
var $author$project$PhotoFolders$init = function (selectedPhotoUrl) {
	return _Utils_Tuple2(
		_Utils_update(
...
var $author$project$PhotoGallery$initialModel = {activity: '', chosenSize: $author$project$PhotoGallery$Medium, hue: 0, noise: 0, ripple: 0, status: $author$project$PhotoGallery$Loading};
...
var $author$project$PhotoGallery$ClickedSupriseMe = {$: 'ClickedSupriseMe'};
	...
	function (photos, selectedUrl, model) {
		return _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$PhotoGallery$ClickedSupriseMe)
					]),
				_List_fromArray(
					[
...
_Platform_export({'Main':{'init':$author$project$Main$main($elm$json$Json$Decode$float)({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"PhotoFolders.Model":{"args":[],"type":"{ selectedPhotoUrl : Maybe.Maybe String.String, photos : Dict.Dict String.String PhotoFolders.Photo, root : PhotoFolders.Folder }"},"PhotoFolders.Photo":{"args":[],"type":"{ title : String.String, size : Basics.Int, relatedUrls : List.List String.String, url : String.String }"},"PhotoGallery.Photo":{"args":[],"type":"{ url : String.String, size : Basics.Int, title : String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"ClickedLink":["Browser.UrlRequest"],"ChangedUrl":["Url.Url"],"GotFoldersMsg":["PhotoFolders.Msg"],"GotGalleryMsg":["PhotoGallery.Msg"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"PhotoFolders.Msg":{"args":[],"tags":{"ClickedPhoto":["String.String"],"GotInitialModel":["Result.Result Http.Error PhotoFolders.Model"],"ClickedFolder":["PhotoFolders.FolderPath"]}},"PhotoGallery.Msg":{"args":[],"tags":{"ClickedPhoto":["String.String"],"SlidHue":["Basics.Int"],"SlidRipple":["Basics.Int"],"SlidNoise":["Basics.Int"],"ClickedSize":["PhotoGallery.ThumbnailSize"],"ClickedSupriseMe":[],"GotRandomPhoto":["PhotoGallery.Photo"],"GotActivity":["String.String"],"GotPhotos":["Result.Result Http.Error (List.List PhotoGallery.Photo)"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"PhotoFolders.Folder":{"args":[],"tags":{"Folder":["{ name : String.String, photoUrls : List.List String.String, subfolders : List.List PhotoFolders.Folder, expanded : Basics.Bool }"]}},"PhotoFolders.FolderPath":{"args":[],"tags":{"End":[],"Subfolder":["Basics.Int","PhotoFolders.FolderPath"]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"PhotoGallery.ThumbnailSize":{"args":[],"tags":{"Small":[],"Medium":[],"Large":[]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});}(this));